...
def submit_action(rec_id: str, body: ActionCreate, db: Session = Depends(get_db)):
    return audit_service.record_action(db, rec_id, body.action, body.auditor.strip(), body.note)
